        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="ChooseProject">Quản lí đồ án</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="Contact.jsp">Liên hệ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="LogOut.jsp">Đăng xuất</a>
                    </li>
                </ul>
                <form class="d-flex" action="SearchTieuDe" method="get" role="searchTieude">
